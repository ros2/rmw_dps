...
#ifndef RMW_DPS_CPP__SERVICETYPESUPPORT_HPP_
#define RMW_DPS_CPP__SERVICETYPESUPPORT_HPP_
...
{
protected:
  ServiceTypeSupport(const MembersType * members);
};
...
#endif  // RMW_DPS_CPP__SERVICETYPESUPPORT_HPP_
