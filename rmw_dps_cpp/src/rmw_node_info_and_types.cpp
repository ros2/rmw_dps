  ...
  rmw_names_and_types_t * topic_names_and_types)
{
  ...
  RCUTILS_LOG_DEBUG_NAMED(
    ...
    __FUNCTION__, node, allocator, node_name, node_namespace, no_demangle, topic_names_and_types);
  ...
  rmw_names_and_types_t * service_names_and_types)
{
  ...
  RCUTILS_LOG_DEBUG_NAMED(
    ...
    __FUNCTION__, node, allocator, node_name, node_namespace, service_names_and_types);
